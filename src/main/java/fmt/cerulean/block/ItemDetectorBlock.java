...
public class ItemDetectorBlock extends BlockWithEntity {
	...
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return validateTicker(type, CeruleanBlockEntities.ITEM_DETECTOR, world.isClient ? null : ItemDetectorBlockEntity::serverTick);
	}
